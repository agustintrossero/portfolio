...
import profilePic from '../../public/images/profile/Sin título-3.png'
            ...
            <div className='w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center'>
              ...
              <p className='my-4 text-base font-medium md:text-sm sm:text-xs'>As a skilled UX/UI Designer and Frontend developer, I am dedicated to turning ideas into innovative web applications. 
                ...
                <div className='flex items-center self-start mt-2 lg:self-center'>
                  <Link href="/AgustínTrossero-Resume.pdf" target={"_blank"} className='flex items-center bg-dark text-light p-2.5 px-6 rounded-lg text-lg font-semibold hover:bg-light hover:text-dark border-2 border-solid border-transparent hover:border-dark
